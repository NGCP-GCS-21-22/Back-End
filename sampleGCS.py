...
class updateDatabase():
    def newEntries (gcsPacket, newestPacketTime, vehicleName):
        ...
        requestedVehicle = updateVehicle.newTimeSinceLastPacket(0)
        requestedVehicle = updateVehicle.newLastPacketTime(0)
        requestedVehicle = updateVehicle.newTime(str(now))
        requestedVehicle = updateVehicle.newErrMsg("None")
        #print(gcsPacket)
